...
def load_environment(num_examples=1000, seed=42) -> vf.MultiTurnEnv:
    ...
    dataset = Dataset.from_dict({
        "question": [f"Please write a short poem, using Markdown formatting when appropriate, about the following word: {random.choice(various_nouns)}" for i in range(num_examples)],
        "answer": [""] * num_examples,
    })
