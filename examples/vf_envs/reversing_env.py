"""
This file is just copied wholecloth from the verifiers examples.
https://github.com/willccbb/verifiers/blob/main/environments/vf_reverse_text/vf_reverse_text.py
"""
