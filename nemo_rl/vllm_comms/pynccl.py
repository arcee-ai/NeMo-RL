...
from nemo_rl.vllm_comms.pynccl_wrapper import (
...
def current_stream() -> torch.cuda.Stream:
    ...
    if not hasattr(_current_stream_tls,
        ...
        # NeMo-RL does not support ROCm, so we don't need the fallback behavior from vLLM.
...
class PyNcclCommunicator:
    ...
    def __init__(
        ...
        logging.info("vLLM is using nccl==%s", self.nccl.ncclGetVersion())
