...
def pack_sequences(
    ...
    Args:
        documents: List of dictionaries, each containing a sequence of data. All dictionaries must have the same keys and all lists within a dictionary must have the same length.
