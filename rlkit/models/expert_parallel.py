...
class TensorParallel(ParallelStyle):
    ...
    def _partition_fn(self, name, module, device_mesh):
        """Partition function for tensor parallel."""
...
class ExpertTensorParallel(ExpertParallel):
    ...
    def _token_dispatch(self, mod, inputs, device_mesh):
        """Token dispatch for expert tensor parallel."""
        routed_input, num_tokens_per_expert = inputs
    ...
    def _partition_fn_2d(self, name, mod, ep_tp_mesh):
        """Partition function for expert tensor parallel."""
        # w1 shape = (experts, out_dim, in_dim)
...
class ReordererSequenceParallel(ParallelStyle):
    """Parallel style to support sequence parallel for ETP=1 when EP borrows from all TP and part of DP."""
    def __init__(self):
        """Initialize reorderer sequence parallel."""
        super().__init__()

    def _prepare_inputput_fn(self, mod, inputs, device_mesh):
        """Prepare the input for reorderer sequence parallel."""
