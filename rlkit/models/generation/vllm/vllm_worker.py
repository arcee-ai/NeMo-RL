...
from rlkit.models.huggingface.common import ModelFlag
from rlkit.models.policy.utils import is_vllm_v1_engine_enabled
...
class BaseVllmGenerationWorker:
    ...
    def __init__(
        ...
        llm_kwargs = dict(
            ...
            worker_extension_cls="rlkit.models.generation.vllm.vllm_backend.VllmInternalWorkerExtension",
...
class VllmGenerationWorker(BaseVllmGenerationWorker):
    ...
    def generate(
        ...
        # Parse tool calls, if a parser is configured.
