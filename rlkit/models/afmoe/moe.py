...
class FeedForward(nn.Module):
    """Feedforward module for AFMoE models."""
    def __init__(
        self,
        dim: int,
        hidden_dim: int,
...
def _run_experts_for_loop(
    ...
    """Run the experts with a simple for loop. You probably don't want to use this."""
...
class GroupedExperts(nn.Module):
    """Grouped experts for AFMoE models."""
    def __init__(
        self,
        dim: int,
        hidden_dim: int,
        ...
        """Initialize the grouped experts module."""
        super().__init__()
    ...
    def forward(
        ...
        """Forward pass for the grouped experts module."""
...
class TokenReorderer(nn.Module):
    ...
    def __init__(self, num_experts: int, top_k: int):
        """Initialize the token reorderer module.
...
class MoE(nn.Module):
    ...
    def __init__(self, moe_args: MoEArgs, dim: int, hidden_dim: int):
        ...
        # Router statistics for logging; aggregated across EP ranks and reset each step
        self.register_buffer(
            "router_stats",
            torch.zeros(num_experts, dtype=torch.float32),
            persistent=False,
