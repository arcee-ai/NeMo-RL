...
ACTOR_ENVIRONMENT_REGISTRY: dict[str, str] = {
    "rlkit.models.generation.vllm_http.vllm_http.VLLMOpenAIServe": VLLM_HTTP_EXECUTABLE,
    ...
    "rlkit.models.policy.dtensor_v2.v2_policy_worker.DTensorV2PolicyWorker": PY_EXECUTABLES.SYSTEM,
...
def get_actor_python_env(actor_class_fqn: str) -> str:
    if actor_class_fqn in ACTOR_ENVIRONMENT_REGISTRY:
        ...
        raise ValueError(
            ...
            "(rlkit.distributed.ray_actor_environment_registry.ACTOR_ENVIRONMENT_REGISTRY) "
