...
echo "Follow instructions on https://github.com/arcee-ai/RLKit/blob/main/docs/guides/use-custom-vllm.md for how to configure your local RLKit environment to use this custom vLLM."
